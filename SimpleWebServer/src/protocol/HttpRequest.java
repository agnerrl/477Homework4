...
///////Function to help get the body to the ConnectionHandler
...
///////////Here is where Im getting the body
		request.body = "";
		if(reader.ready()){
			System.out.println("we are getting ready to read the body");
			line = reader.readLine();
			 while(!line.equals("")){
				 request.body += line;
				 line = reader.readLine();
				 System.out.println("a line was put into the body");
			 }
			System.out.println("we have finished the body");
		}
		return request;
	}
